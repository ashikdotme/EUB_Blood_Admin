    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-danger">
                <h4 class="modal-title" id="danger-header-modalLabel">Delete User</h4>
...
.then(function(response){ 
    if(response.status==200){ 
        ...
        $.each(jsonData,function(i,item){
            ...
            function buttonEdit(){
                return '<a href="view-user?id='+jsonData[i].id+'" class="btn btn-success btn-sm ViewBtn ViewBtn'+jsonData[i].id+'"> <i class="fas fa-eye"></i></a> '+
                '<a href="update-user?id='+jsonData[i].id+'" class="btn btn-warning btn-sm EditBtn EditBtn'+jsonData[i].id+'"> <i class="fas fa-edit"></i></a>';
            }
